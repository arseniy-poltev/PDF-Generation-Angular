            ...
            function i(w, z, y, v, A) {
                  ...
                  if (v == undefined || v == "") {
                        if (window && window.location.toString().indexOf("jqwidgets.com") >= 0) {
                              v = "http://jqwidgets.com/export_server/dataexport.php"
                        } else {
...
(function(b) {
      var a = function() {
            var h, l, d, i, c, j, m = {style: "", stylesMap: {font: {color: "Color", "font-family": "FontName", "font-style": "Italic", "font-weight": "Bold"}, interior: {"background-color": "Color", background: "Color"}, alignment: {left: "Left", center: "Center", right: "Right"}}, startStyle: function(p) {
...
(function(d) {
      var j = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, l = {"\b": "\\b", "\t": "\\t", "\n": "\\n", "\f": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\"};
      function a(n) {
...
var pdfDataExport = (function() {
      if (typeof btoa === "undefined") {
            window.btoa = function(m) {
                  var h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s = h.split(""), g, f, e, q, p, o, n, t, l = 0, u = 0, k = "", j = [], d;
                  do {
                        g = m.charCodeAt(l++);
                        f = m.charCodeAt(l++);
                        e = m.charCodeAt(l++);
      ...
      if (typeof atob === "undefined") {
            window.atob = function(l) {
                  var g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", f, e, d, p, o, n, m, q, k = 0, r = 0, h = "", j = [];
                  if (!l) {
                        return l
                  }
                  l += "";
      ...
      var c = typeof Object.keys === "function" ? function(d) {
            ...
            this.publish = function(h, m) {
                  if (this.topics[h]) {
                        var j = this.topics[h], o = [], n, g, e, f, k = function() {
                        };
            ...
            this.subscribe = function(e, g, f) {
                  ...
                  return{topic: e, callback: g}
            };
            this.unsubscribe = function(h) {
                  if (this.topics[h.topic]) {
                        var f = this.topics[h.topic], g, e;
      ...
      function b(E, ae, M, V) {
            ...
            var at = M.toString().toLowerCase(), ao = "0.9.0rc2", t = [], F = 0, av = V, U = "1.3", N = {a3: [841.89, 1190.55], a4: [595.28, 841.89], a5: [420.94, 595.28], letter: [612, 792], legal: [612, 1008]}, ad = "0 g", H = "0 G", g = 0, f = [], n = 2, v = false, D = [], ai = {}, Q = {}, aj = 16, d, z = 0.200025, B, C, ak, O = {title: "", subject: "", author: "", keywords: "", creator: ""}, R = 0, T = 0, P = {}, G = new a(P), af, aq, p = function(i) {
                  return i.toFixed(2)
            }, o = function(i) {
                  return i.toFixed(3)
            }, A = function(i) {
                  ...
                  G.publish("addFonts", {fonts: ai, dictionary: Q})
            }, s = function(aG, ax) {
                  ...
                  G.publish("addPage", {pageNumber: g})
            }, y = function(aw, ay) {
                  var i, k;
                  if (aw === k) {
                        aw = ai[d].fontName
                  ...
                  switch (az) {
                        ...
                        case"save":
                              ...
                              k = new Blob([aC], {type: "application/pdf"});
                              saveAs(k, aw);
                              break;
                        case"datauristring":
                        case"dataurlstring":
            ...
            P.internal = {pdfEscape: Z, getStyle: ac, getFont: function() {
                        return ai[y.apply(P, arguments)]
                  }, getFontSize: function() {
                        return aj
                  }, btoa: btoa, write: function(i, ax, aw, k) {
                        ...
                        return p((B - i) * ak)
                  }, collections: {}, newObject: w, putStream: K, events: G, scaleFactor: ak, pageSize: {width: C, height: B}, output: function(k, i) {
                        return I(k, i)
                  }};
            P.addPage = function() {
                  ah();
            ...
            P.ellipse = function(i, aB, az, ay, k) {
                  var aA = ac(k), ax = 4 / 3 * (Math.SQRT2 - 1) * az, aw = 4 / 3 * (Math.SQRT2 - 1) * ay;
            ...
            P.CapJoinStyles = {0: 0, butt: 0, but: 0, bevel: 0, 1: 1, round: 1, rounded: 1, circle: 1, 2: 2, projecting: 2, project: 2, square: 2, milter: 2};
...
(function(i) {
      var b = 0, m = 0, a, o, h, c = {x: undefined, y: undefined, w: undefined, h: undefined, ln: undefined}, f = 1, e = false, d = function(p, t, q, r, s) {
            c = {x: p, y: t, w: q, h: r, ln: s}
      }, k = function() {
            return c
      }, j = function(p) {
            b = p
      ...
      i.getTextDimensions = function(p) {
            ...
            q = {w: (r.offsetWidth + 1) * s, h: (r.offsetHeight + 1) * s};
      ...
      i.cellInitialize = function() {
            b = 0;
            c = {x: undefined, y: undefined, w: undefined, h: undefined, ln: undefined};
            f = 1;
            e = false;
            n(0)
      };
      i.cell = function(z, v, A, s, p, u) {
            ...
            var B = k(), r = this.getTextDimensions(p), t = 1;
      ...
      i.table = function(J, r, I) {
            var v = [], p = [], D, z, B, x, E, y, G = {}, A = {}, u, s, H = [], C, F = [], t, q, w;
            this.lnMod = 0;
            if (I) {
                  z = I.autoSize || false;
...
(function(c) {
      var b = c.getCharWidthsArray = function(s, u) {
            ...
            var h = u.widths ? u.widths : this.internal.getFont().metadata.Unicode.widths, r = h.fof ? h.fof : 1, n = u.kerning ? u.kerning : this.internal.getFont().metadata.Unicode.kerning, p = n.fof ? n.fof : 1;
            var m, j, o, k, q = 0, t = h[0] || r, g = [];
      ...
      var f = function(s, k, v) {
            ...
            var t = b(" ", v)[0];
            var r = s.split(" ");
            var w = [], x = [w], h = v.textIndent || 0, u = 0, p = 0, g, q;
            var o, m, n;
      ...
      c.splitTextToSize = function(q, m, r) {
            ...
            var h = r.fontSize || this.internal.getFontSize(), g = (function(l) {
                  var t = {0: 1}, i = {};
                  if (!l.widths || !l.kerning) {
                        var u = this.internal.getFont(l.fontName, l.fontStyle), s = "Unicode";
                        if (u.metadata[s]) {
                              return{widths: u.metadata[s].widths || t, kerning: u.metadata[s].kerning || i}
                        }
                  } else {
                        return{widths: l.widths, kerning: l.kerning}
                  }
                  return{widths: t, kerning: i}
            }).call(this, r);
            var p;
            if (q.match(/[\n\r]/)) {
                  p = q.split(/\r\n|\r|\n/g)
...
(function(c) {
      ...
      c.addImage = function(g, s, q, p, t, l) {
            ...
            var i, n = this.internal.collections[d + "images"], m = this.internal.getCoordinateString, o = this.internal.getVerticalCoordinateString;
...
var saveAs = saveAs || (navigator.msSaveBlob && navigator.msSaveBlob.bind(navigator)) || (function(h) {
      ...
      }, e = h.URL || h.webkitURL || h, n = $("<a></a>")[0], g = "download" in n, j = function(t) {
